package com.zeneng.zhixingheyi.agent.examples;

import com.zeneng.zhixingheyi.agent.tools.test.CityTool;
import com.zeneng.zhixingheyi.agent.tools.test.DateTool;
import com.zeneng.zhixingheyi.agent.tools.test.WeatherTool;
 ...
 */
@SpringBootTest
public class ZhiXingHeYiV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        ZhiXingHeYiV2 agent = new ZhiXingHeYiV2(
                "test-agent-v2",
                "测试 Agent V2",
