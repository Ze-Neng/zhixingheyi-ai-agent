...
import com.zeneng.zhixingheyi.converter.DocumentConverter;
import com.zeneng.zhixingheyi.exception.BizException;
import com.zeneng.zhixingheyi.mapper.DocumentMapper;
import com.zeneng.zhixingheyi.model.dto.ChunkBgeM3DTO;
import com.zeneng.zhixingheyi.model.dto.DocumentDTO;
import com.zeneng.zhixingheyi.model.entity.Document;
...
import com.zeneng.zhixingheyi.mapper.ChunkBgeM3Mapper;
import com.zeneng.zhixingheyi.model.entity.ChunkBgeM3;
import com.zeneng.zhixingheyi.service.DocumentFacadeService;
import com.zeneng.zhixingheyi.service.DocumentStorageService;
import com.zeneng.zhixingheyi.service.MarkdownParserService;
import com.zeneng.zhixingheyi.service.RagService;
    ...
    public CreateDocumentResponse uploadDocument(String kbId, MultipartFile file) {
        try {
            ...
            if ("md".equalsIgnoreCase(filetype) || "markdown".equalsIgnoreCase(filetype)) {
                ...
                log.info("暂不支持的文件类型: {}，仅支持 .md 文件", filetype);
            }
        ...
        try {
            ...
            try (InputStream inputStream = Files.newInputStream(path)) {
                ...
                for (MarkdownParserService.MarkdownSection section : sections) {
                    ...
                    // 对内容进行 embedding（改为 embed content，而非 title）
                    float[] embedding = ragService.embed(content);

                    // 将标题信息存储到 metadata
                    String metadataJson = null;
                    if (title != null && !title.trim().isEmpty()) {
                        ChunkBgeM3DTO.MetaData meta = new ChunkBgeM3DTO.MetaData();
                        meta.setTitle(title);
