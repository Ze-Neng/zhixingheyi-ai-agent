package com.zeneng.zhixingheyi.agent;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.zeneng.zhixingheyi.agent.tools.Tool;
import com.zeneng.zhixingheyi.config.ChatClientRegistry;
import com.zeneng.zhixingheyi.converter.AgentConverter;
import com.zeneng.zhixingheyi.converter.ChatMessageConverter;
import com.zeneng.zhixingheyi.converter.KnowledgeBaseConverter;
import com.zeneng.zhixingheyi.mapper.AgentMapper;
import com.zeneng.zhixingheyi.mapper.KnowledgeBaseMapper;
import com.zeneng.zhixingheyi.model.dto.AgentDTO;
import com.zeneng.zhixingheyi.model.dto.ChatMessageDTO;
import com.zeneng.zhixingheyi.model.dto.KnowledgeBaseDTO;
import com.zeneng.zhixingheyi.model.entity.Agent;
import com.zeneng.zhixingheyi.model.entity.KnowledgeBase;
import com.zeneng.zhixingheyi.service.ChatMessageFacadeService;
import com.zeneng.zhixingheyi.service.SseService;
import com.zeneng.zhixingheyi.service.ToolFacadeService;
...
@Component
public class ZhiXingHeYiFactory {

    private static final Logger log = LoggerFactory.getLogger(ZhiXingHeYiFactory.class);
    ...
    private ZhiXingHeYi buildAgentRuntime(
            Agent agent,
            List<Message> memory,
     ...
     * 创建一个 ZhiXingHeYi 实例
     */
    public ZhiXingHeYi create(String agentId, String chatSessionId) {
